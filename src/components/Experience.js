    ...
    <div className="container mx-auto p-4">
      ...
      <div className="mb-6">
        <div className="flex flex-col items-start cursor-pointer" onClick={() => toggleDetails('showDetails1')}>
          <p className="font-bold">Associate Software Developer</p>
        <svg
          ...
          <p className="text-gray-600 font-bold">Nagarro, Gurgaon, India </p>
          <span className='bg-darkblue text-white p-2 rounded'>Aug 2022 – Present</span>
      ...
      <div className="mb-6">
        <div className="flex flex-col items-start cursor-pointer" onClick={() => toggleDetails('showDetails2')}>
          <p className="font-bold">Software Developer Trainee</p>
          <p className="text-gray-600">Nagarro, Gurgaon, India</p>
          <span className='bg-darkblue text-white p-2 rounded'> Feb 2022 – Aug 2022</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
